# Instructivo utilización del programa
...
7. En caso de que haya presionado 2 puede mutar el ADN de manera horizontal, vertical o diagonal presionando la tecla **H** (Horizontal, **V** (Vertical) ó **D** (Diagonal).
